    ...
    function loadCourse() {
      tableIns = table.render({
        ...
        cols : [[
            ...
            {field: 'id', title: '公司编号', sort:true, minWidth:80, align:"left"},
            {field: 'courseName', title: '公司名',minWidth:120, align:'left'},
            {field: 'teacherName', title: '指导教师',minWidth:120, align:'left'},
            {field: 'startDate', title: '开始时间', minWidth:100, align:'center'},
            {field: 'endDate', title: '结束时间', minWidth:100, align:'center'},
            {field: 'classHour', title: '实习时间', minWidth:100, align:'center'},
